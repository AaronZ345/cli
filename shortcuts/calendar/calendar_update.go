...
var CalendarUpdate = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "description-rich", Desc: "event description as Markdown (@file or - for stdin); the unified description field. Supports bold/italic/underline/strikethrough, links, ordered/unordered lists, and GFM tables. A Lark doc URL (bare or as a Markdown link) is auto-resolved to an inline doc-mention chip showing its title.", Input: []string{common.File, common.Stdin}},
