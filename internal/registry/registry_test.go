...
// [readonly, subject:read, address:read, body:read]; collecting only the
// bestScope (readonly) would leave a fully-authorized user unable to read a
// message's subject/address/body.
